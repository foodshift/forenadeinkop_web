...
const IndexPage = () => (
  <Layout>
    ...
    <section className='top-left-white pt5 pt6-l pb4 pb5-l ph3 ph5-ns'>
      <div className='cf w-100 center mw9'>
        ...
        <div className='fr tk-rift-soft f3 f2-l lh-copy'>
          <Link to='/blogg' className='menu fi-gray mr4 link underline'>BLOGG</Link>
          <Link to='/karta' className='menu fi-gray link underline'>KARTA</Link>
        </div>
    ...
    <Section backgroundColor='bg-fi-green' textColor='near-white'>
      <Link to='/blogg' className='tk-rift-soft link underline white'><h2 className='f2-l f3 lh-copy mt0 mb3'>Blogg</h2></Link>
    ...
    <Section>
      <div className='bg-fi-pink fl w-100 mh0 mt4'>
        <div className='fl w-100 w-40-l mh0 mt0 pr0 pr3-l measure lh-copy f5 f4-l mb4 mb3-l mr4-l'>
          <h2 className='tk-rift-soft f2-l f3 lh-copy mt0 mb1'>Är du inte medlem i en förening än?</h2>
          Skulle du vilja starta? Anmäl dig till Förenade Inköp och få hjälp att komma igång.
          <p><FontAwesomeIcon icon={faCheckCircle} color='#c57810' /> Få stöd av Coompanion och erfarna föreningsmedlemmar</p>
          <p><FontAwesomeIcon icon={faCheckCircle} color='#c57810' /> Delta på träffar och workshops</p>
          <p><FontAwesomeIcon icon={faCheckCircle} color='#c57810' /> Kom i kontakt med andra som ligger i startgroparna</p>

        </div>
        <div className='fl w-100 w-40-l mh0 mt0 pr0 pr3-l measure lh-copy f5 f4-l mb4 mb3-l'>
          <h2 className='tk-rift-soft f2-l f3 lh-copy mt0 mb1'>Är du medlem i en inköpsförening eller kooperativ matbutik?</h2>
          Vi behöver din hjälp och ditt kunnande när vi skriver "En handbok för inköpsföreningar"!
          <p><FontAwesomeIcon icon={faCheckCircle} color='#c57810' /> Bygg nätverk med andra inköpsföreningar</p>
          <p><FontAwesomeIcon icon={faCheckCircle} color='#c57810' /> Diskutera arbetssätt och rutiner</p>
          <p><FontAwesomeIcon icon={faCheckCircle} color='#c57810' /> Dela med dig av dina erfarenheter</p>
        </div>
      </div>
    </Section>
    ...
    <Section backgroundColor='bg-fi-green' textColor='white'>
      <div className='fl w-100 mh0 mb1 mb2-ns'>
        <h2 className='tk-rift-soft f2-l f3 lh-copy mt0 mb1'>Delta i projektet!</h2>
    ...
    <Section>
      <div className='fl w-100 mh0 mb2 mb3-ns pt2'>
        <div className='fl w-100 w-50-l mh0 mt0 pr0 pr3-l measure lh-copy f5 f4-l'>
          ...
          <p className='mt2'>Dokumentera befintliga föreningar, skriv och filma! Sammanställ insikter i en <a href='https://handbok.forenadeinkop.se' className='link fi-link'>handbok</a> som kan hjälpa nya att komma igång.</p>
          ...
          <p className='mt2'>Projektet är initierat av <a href='https://foodshift.se' className='link fi-link'>Food Shift</a> och <a href='https://sormland.coompanion.se/' className='link fi-link'>Coompanion Sörmland</a>.</p>
    ...
    <Section>
      <div className='fl w-100 mh0 mb2 mb3-ns pt2'>
        <div className='fl w-100 w-50-l mh0 mt0 pr0 pr3-l measure lh-copy f5 f4-l'>
          <h2 className='tk-rift-soft f2-l f3 lh-copy mt0 mb1'>Om Food Shift</h2>
        ...
        <div className='fl w-100 w-50-l mh0 mt0 pr0 pl3-l measure lh-copy f5 f4-l'>
          <h2 className='tk-rift-soft f2-l f3 lh-copy mt0 mb1'>Om Coompanion</h2>
        ...
        <div className='cf w-100 center mw9 tk-atten-round-new'>
          ...
          <div className='w-100 tc'>
            <div className='tc dib ph4 pv2'>
              ...
              <p className='mb1 mt0'><a href='mailto:marcus@foodshift.se' className='link fi-link'>marcus@foodshift.se</a></p>
            </div>
            ...
            <div className='tc dib ph4 pv2'>
              ...
              <p className='mb1 mt0'><a href='mailto:zaunders@gmail.com' className='link fi-link'>zaunders@gmail.com</a></p>
            </div>
            ...
            <div className='tc dib ph4 pv2'>
              ...
              <p className='mb1 mt0'><a href='mailto:kristofer@foodshift.se' className='link fi-link'>kristofer@foodshift.se</a></p>
            </div>
